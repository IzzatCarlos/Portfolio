  ...
  return (
    <section id="projetos" className="bg-white px-6 py-32 border-t border-neutral-100">
      <div className="mx-auto max-w-7xl">
        {/* Título: Padronizado para Semibold e Tamanho md:text-5xl */}
        ...
        {/* Subtítulo: Padronizado para neutral-700 e tamanho base/lg */}
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            ...
            >
              {/* Container da imagem - mais minimalista */}
              ...
              <div className="flex flex-1 flex-col p-8">
                ...
                {/* Título do Projeto: Semibold e neutral-950 */}
                ...
                {/* Botão de Repositório: Mais limpo, apenas com sutil hover azul */}
                <div className="mt-10">
                  <Button 
                    asChild 
                    variant="outline" 
                    size="lg" 
                    className="w-full rounded-full border-neutral-300 py-6 text-base font-semibold text-neutral-900 transition-all hover:bg-neutral-950 hover:text-white hover:border-neutral-950"
                  >
